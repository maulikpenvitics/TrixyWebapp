    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            try
            {
                ...
                List<string?> stocklst = user?.Stocks?.Where(x => x.IsActive == true).Select(x => x.Symbol).ToList()??new List<string?>();
            ...
            {
                await _errorhandling.AddErrorHandling(ex, "Home/Index");
        ...
        public async Task<IActionResult> RealTimeData()
        {
            ...
            {
                await _errorhandling.AddErrorHandling(ex, "Home/RealTimeData");
                Helper.LogFilegenerate(ex, "Login Action", _env);
            }
        ...
        public async Task<IActionResult> FetchData(string sym)
        {
          ...
          .Select(group => new
          {
            ...
            {
                await _errorhandling.AddErrorHandling(ex, "Home/FetchData");
                return Json(null);
            }
        ...
        public async Task<IActionResult> GetChartDetails(string sym)
        {
            ...
            {
                await _errorhandling.AddErrorHandling(ex, "Home/GetChartDetails");
                return Json(null);
            }
        ...
        public async Task<IActionResult> UpdateStrategyStatus(string userId, string strategyName, string status)
        {
            ...
            {
                await _errorhandling.AddErrorHandling(ex, "Home/UpdateStrategyStatus");
                return Ok(new { message = "Please try agin." });
            }
        ...
        public async Task<IActionResult> EnableDisableStratgey(string sym, bool isEnable)
        {
            ...
            {
                await _errorhandling.AddErrorHandling(ex, "Home/EnableDisableStratgey");
                return RedirectToAction("Index");
            }
        ...
        public async Task<Dictionary<string, string>> Recomddation(string sym)
        {
            ...
            {
                await _errorhandling.AddErrorHandling(ex, "Home/Recomddation");
                return keyValuePairs;
            }
        ...
        public async Task<IActionResult> Removestockfromuser(string sym)
        {
            ...
            {
                await _errorhandling.AddErrorHandling(ex, "Home/Removestockfromuser");
                return RedirectToAction("Index");
            }
